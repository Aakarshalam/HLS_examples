...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.systolic_array_kernel.autotvin_gmem0.dat"
         "c.systolic_array_kernel.autotvin_gmem1.dat"
         "c.systolic_array_kernel.autotvin_A.dat"
         "c.systolic_array_kernel.autotvin_B.dat"
         "c.systolic_array_kernel.autotvin_C.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.systolic_array_kernel.autotvout_gmem2.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
