...
`define AUTOTB_DUT      systolic_array_kernel
`define AUTOTB_DUT_INST AESL_inst_systolic_array_kernel
`define AUTOTB_TOP      apatb_systolic_array_kernel_top
`define AUTOTB_LAT_RESULT_FILE "systolic_array_kernel.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "systolic_array_kernel.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_systolic_array_kernel_top
...
`define AUTOTB_TVIN_gmem0_out_wrapc  "../tv/rtldatafile/rtl.systolic_array_kernel.autotvin_gmem0.dat"
`define AUTOTB_TVIN_gmem1_out_wrapc  "../tv/rtldatafile/rtl.systolic_array_kernel.autotvin_gmem1.dat"
`define AUTOTB_TVIN_A_out_wrapc  "../tv/rtldatafile/rtl.systolic_array_kernel.autotvin_A.dat"
`define AUTOTB_TVIN_B_out_wrapc  "../tv/rtldatafile/rtl.systolic_array_kernel.autotvin_B.dat"
`define AUTOTB_TVIN_C_out_wrapc  "../tv/rtldatafile/rtl.systolic_array_kernel.autotvin_C.dat"
`define AUTOTB_TVOUT_gmem2  "../tv/cdatafile/c.systolic_array_kernel.autotvout_gmem2.dat"
`define AUTOTB_TVOUT_gmem2_out_wrapc  "../tv/rtldatafile/rtl.systolic_array_kernel.autotvout_gmem2.dat"
module `AUTOTB_TOP;
