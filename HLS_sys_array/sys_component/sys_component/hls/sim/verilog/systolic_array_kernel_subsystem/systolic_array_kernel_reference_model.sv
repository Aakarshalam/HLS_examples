...
`ifndef SYSTOLIC_ARRAY_KERNEL_REFERENCE_MODEL_SV
`define SYSTOLIC_ARRAY_KERNEL_REFERENCE_MODEL_SV
typedef class systolic_array_kernel_reference_model;
...
class systolic_array_kernel_reference_model extends uvm_component;
`define TV_IN_gmem0 "../tv/cdatafile/c.systolic_array_kernel.autotvin_gmem0.dat"
`define TV_OUT_gmem0 "../tv/rtldatafile/rtl.systolic_array_kernel.autotvout_gmem0.dat"
`define TV_IN_OFFSET_A "../tv/cdatafile/c.systolic_array_kernel.autotvin_A.dat"
`define TV_IN_gmem1 "../tv/cdatafile/c.systolic_array_kernel.autotvin_gmem1.dat"
`define TV_OUT_gmem1 "../tv/rtldatafile/rtl.systolic_array_kernel.autotvout_gmem1.dat"
`define TV_IN_OFFSET_B "../tv/cdatafile/c.systolic_array_kernel.autotvin_B.dat"
`define TV_IN_gmem2 "../tv/cdatafile/c.systolic_array_kernel.autotvin_gmem2.dat"
`define TV_OUT_gmem2 "../tv/rtldatafile/rtl.systolic_array_kernel.autotvout_gmem2.dat"
`define TV_IN_OFFSET_C "../tv/cdatafile/c.systolic_array_kernel.autotvin_C.dat"
`define TV_IN_A "../tv/cdatafile/c.systolic_array_kernel.autotvin_A.dat"
`define TV_OUT_A ""
`define TV_IN_B "../tv/cdatafile/c.systolic_array_kernel.autotvin_B.dat"
`define TV_OUT_B ""
`define TV_IN_C "../tv/cdatafile/c.systolic_array_kernel.autotvin_C.dat"
`define TV_OUT_C ""
    ...
    `uvm_component_utils_begin(systolic_array_kernel_reference_model)
