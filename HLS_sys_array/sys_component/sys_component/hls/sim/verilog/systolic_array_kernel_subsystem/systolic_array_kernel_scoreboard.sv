...
//
//==============================================================
`ifndef SYSTOLIC_ARRAY_KERNEL_SCOREBOARD__SV                                                       
    `define SYSTOLIC_ARRAY_KERNEL_SCOREBOARD__SV                                                   
                                                                                               
                                                                                               
    class systolic_array_kernel_scoreboard extends uvm_component;                                        
                                                                                               
        systolic_array_kernel_reference_model refm;                                                      
                                                                                               
                                                                                               
        `uvm_component_utils_begin(systolic_array_kernel_scoreboard)                                     
