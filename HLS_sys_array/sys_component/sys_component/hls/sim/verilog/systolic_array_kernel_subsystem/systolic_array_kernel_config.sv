...
//
//==============================================================
`ifndef SYSTOLIC_ARRAY_KERNEL_CONFIG__SV                        
    `define SYSTOLIC_ARRAY_KERNEL_CONFIG__SV                    
                                                            
    class systolic_array_kernel_config extends uvm_object;            
        ...
        `uvm_object_utils_begin(systolic_array_kernel_config)         
        ...
        function new (string name = "systolic_array_kernel_config");
            super.new(name);                                
