...
if {[file isfile systolic_array_kernel.autotvin.dat]} {
	file delete -force systolic_array_kernel.autotvin.dat
}

if {[file isfile systolic_array_kernel.autotvout.dat]} {
	file delete -force systolic_array_kernel.autotvout.dat
}
