...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "systolic_array_kernel.autotvin.dat"
	set constFileTvOut       "systolic_array_kernel.autotvout.dat"
	set constFileHdlTvIn     "systolic_array_kernel.autohdltvin.dat"
	set constFileHdlTvOut    "systolic_array_kernel.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
