...
typedef ap_uint<8> led_t;
typedef ap_uint<32> counter_t;


__attribute__((sdx_kernel("led_blink", 0))) void led_blink(
    counter_t delay_count,
    bool enable,
    led_t *led_out
);
# 13 "led_blink.cpp" 2
...
#line 1 "directive"
#pragma HLSDIRECTIVE TOP name=led_blink
# 18 "led_blink.cpp"
