...
HLS_SOURCES = ../../../../tb_led.cpp ../../../../led_blink.cpp
...
$(ObjDir)/tb_led.o: ../../../../tb_led.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../tb_led.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/tb_led.d

$(ObjDir)/led_blink.o: ../../../../led_blink.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../led_blink.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/led_blink.d
