...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "led_blink.autotvin.dat"
	set constFileTvOut       "led_blink.autotvout.dat"
	set constFileHdlTvIn     "led_blink.autohdltvin.dat"
	set constFileHdlTvOut    "led_blink.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
