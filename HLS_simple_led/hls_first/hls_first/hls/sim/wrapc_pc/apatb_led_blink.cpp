...
// wrapc file define:
#define AUTOTB_TVIN_delay_count "../tv/cdatafile/c.led_blink.autotvin_delay_count.dat"
#define AUTOTB_TVOUT_delay_count "../tv/cdatafile/c.led_blink.autotvout_delay_count.dat"
#define AUTOTB_TVIN_enable "../tv/cdatafile/c.led_blink.autotvin_enable.dat"
#define AUTOTB_TVOUT_enable "../tv/cdatafile/c.led_blink.autotvout_enable.dat"
#define AUTOTB_TVIN_led_out "../tv/cdatafile/c.led_blink.autotvin_led_out.dat"
#define AUTOTB_TVOUT_led_out "../tv/cdatafile/c.led_blink.autotvout_led_out.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_led_out "../tv/rtldatafile/rtl.led_blink.autotvout_led_out.dat"
...
extern "C"
void led_blink_hw_stub_wrapper(hls::sim::Byte<4>*, hls::sim::Byte<1>, void*);

extern "C"
void apatb_led_blink_hw(hls::sim::Byte<4>* __xlx_apatb_param_delay_count, hls::sim::Byte<1> __xlx_apatb_param_enable, void* __xlx_apatb_param_led_out)
{
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_delay_count),
#endif
  };
  port0.param = __xlx_apatb_param_delay_count;
  ...
  port1.param = &__xlx_apatb_param_enable;

  static hls::sim::Register port2 {
    .name = "led_out",
    .width = 8,
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_led_out),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_led_out),
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_led_out),
#endif
  };
  port2.param = __xlx_apatb_param_led_out;
  ...
  try {
    ...
    led_blink_hw_stub_wrapper(__xlx_apatb_param_delay_count, __xlx_apatb_param_enable, __xlx_apatb_param_led_out);
