...
if {[file isfile led_blink.autotvin.dat]} {
	file delete -force led_blink.autotvin.dat
}

if {[file isfile led_blink.autotvout.dat]} {
	file delete -force led_blink.autotvout.dat
}
